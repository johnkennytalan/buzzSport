            ...
            <div class="article-container">
             <div class="page-container">
               <article id="writer" class="card">
                  ...
                  <small>
                     <p><strong>Image source: </strong>March Supercross Ends with a Flourish.(April 1, 2022).Allextreme.https://all-extreme.com/march-supercross-ends-with-a-flourish/
                     </p>
                  </small>
                  <h2 class="l-heading">March Supercross Ends with a Flourish.</h2>
                  <div class="meta">
                     <small>
