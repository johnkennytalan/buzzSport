            ...
            <div class="article-container">
             <div class="page-container">
               <article id="writer" class="card">
                  ...
                  <small>
                     <p><strong>Image source: </strong>Flore-Colina, C.(May 16, 2022).<em>Philippines’ first swimming gold in Hanoi.</em>Inquirer.net.https://sports.inquirer.net/462765/sea-games-chloe-isleta-wins-philippines-first-swimming-gold-in-hanoi
                     </p>
                  </small>
                  <h2 class="l-heading">Philippines’ first swimming gold in Hanoi.</h2>
                  <div class="meta">
                     <small>
                        <i class="fas fa-user">Written by: John Doe | May 15, 2023</i>
                     </small>
                     <div class="category category-aquatics">Aquatics</div>
                  </div>
