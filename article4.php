            ...
            <div class="article-container">
             <div class="page-container">
               <article id="writer" class="card">
                  ...
                  <small>
                     <p><strong>Image source: </strong>Villar, J.(June 3, 2022).<em>Wesley So moves to No. 5 in world chess rankings with latest win.</em>Philstar.https://www.philstar.com/sports/2022/06/03/2185806/wesley-so-moves-no-5-world-chess-rankings-latest-win
                     </p>
                  </small>
                  <h2 class="l-heading">Wesley So moves to No. 5 in world chess rankings with latest win.</h2>
                  <div class="meta">
                     <small>
